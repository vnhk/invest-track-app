...
public class HighVolumeMomentumStrategy implements RecommendationStrategy {
    ...
    private String fileName(LocalDate day, String part) {
        return "STOCKS_PL_" + day.getDayOfMonth() + "_"
                + day.getMonthValue() + "_" + part + ".xlsx";
    }

    private List<StockPriceData> getGood(List<StockPriceData> rec,
    ...
    private List<StockPriceData> getBad(List<StockPriceData> rec,
                                        List<StockPriceData> evening) {
